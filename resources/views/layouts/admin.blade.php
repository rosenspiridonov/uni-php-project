    ...
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav side-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('all.courses')}}" style="margin-left: 20px;">Courses</a>
          </li>
          <li class="nav-item">
            <a class="nav-link"  href="{{route('all.organizations')}}" style="margin-left: 20px;">Organizations</a>
          </li>
        </ul>
        @endauth
