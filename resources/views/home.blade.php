...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h6 class="section-title bg-white text-center text-primary px-3">Organizations</h6>
            <h1 class="mb-5">Expert Organizations</h1>
        </div>
        <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden text-center">
                            <img class="img-fluid" src="{{ asset('assets/img/' . $organization->image) }}" alt="">
                        </div>
